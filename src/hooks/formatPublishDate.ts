...
export const formatPublishDate = (date: Date): string => {
   ...
   if (timeSpan < 0) {
      ...
      return Math.floor(timeSpan / (60 * 60 * 1000)) + ' hours önce'
   } else if (timeSpan < 7 * 24 * 60 * 60 * 1000) {
      return Math.floor(timeSpan / (24 * 60 * 60 * 1000)) + ' days önce'
   } else if (timeSpan < 30 * 24 * 60 * 60 * 1000) {
      return Math.floor(timeSpan / (7 * 24 * 60 * 60 * 1000)) + ' weeks önce'
   } else if (timeSpan < 365 * 24 * 60 * 60 * 1000) {
      return Math.floor(timeSpan / (30 * 24 * 60 * 60 * 1000)) + ' months önce'
   } else {
      return Math.floor(timeSpan / (365 * 24 * 60 * 60 * 1000)) + ' years önce'
   }
}